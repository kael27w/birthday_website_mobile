...
function End() {
    ...
    const sentences = [
      "Gracias por todo   lo que haces por   la familia y por mi",
      "Te amo mucho ❤️"
    ]
        ...
        <div className="w-[90%] max-w-[400px] px-8">
          {sentences.slice(0, visibleCount).map((sentence, index) => (
            <p
              ...
              className="text-4xl font-bold text-customBlue drop-shadow-lg text-center mb-4 whitespace-pre-line leading-relaxed"
            >
              {index === 0 ? (
